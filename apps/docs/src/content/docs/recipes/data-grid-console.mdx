    ...
    <md-table selection="multiple" striped label="Workspace members"
      ...
      <md-table-body>
        <md-table-row value="u-01">
          ...
          <md-table-cell><span style="display: inline-flex; align-items: center; gap: 8px;"><span style="position: relative; display: inline-flex; inline-size: 8px; block-size: 8px; --md-status-dot-inset-end: 0px; --md-status-dot-inset-block-end: 0px;"><md-status-dot size="small" state="online"></md-status-dot></span>Active</span></md-table-cell>
  ...
  script={`
    ...
    function rowHtml(m) {
      return '<md-table-row value="' + m.id + '">' +
        ...
        '<span style="position: relative; display: inline-flex; inline-size: 8px; block-size: 8px; --md-status-dot-inset-end: 0px; --md-status-dot-inset-block-end: 0px;">' +
        '<md-status-dot size="small" state="' + STATE[m.status] + '"></md-status-dot></span>' + m.status + '</span></md-table-cell>' +
...
const dotAnchor = { position: 'relative', display: 'inline-flex', inlineSize: '8px',
  blockSize: '8px', '--md-status-dot-inset-end': '0px', '--md-status-dot-inset-block-end': '0px' };
              ...
              <MdTableRow key={m.id} value={m.id}>
                ...
                <MdTableCell>
                  <span style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
                    <span style={dotAnchor}><MdStatusDot size="small" state={DOT[m.status]} /></span>
                    {m.status}
                  </span>
                </MdTableCell>
        ...
        <md-table-row [value]="m.id">
          ...
          <md-table-cell>
            <span style="display: inline-flex; align-items: center; gap: 8px;">
              <span style="position: relative; display: inline-flex; inline-size: 8px; block-size: 8px; --md-status-dot-inset-end: 0px; --md-status-dot-inset-block-end: 0px;">
                <md-status-dot size="small" [state]="dot[m.status]"></md-status-dot>
              </span>{{ m.status }}
            </span>
          </md-table-cell>
          <md-table-cell numeric>{{ ago(m.hoursAgo) }}</md-table-cell>
      ...
      <MdTableBody>
        <MdTableRow v-for="m in pageRows" :key="m.id" :value="m.id">
          ...
          <MdTableCell>
            <span style="display: inline-flex; align-items: center; gap: 8px;">
              <span style="position: relative; display: inline-flex; inline-size: 8px; block-size: 8px; --md-status-dot-inset-end: 0px; --md-status-dot-inset-block-end: 0px;">
                <MdStatusDot size="small" :state="DOT[m.status]" />
              </span>{{ m.status }}
            </span>
          </MdTableCell>
          <MdTableCell numeric>{{ ago(m.hoursAgo) }}</MdTableCell>
