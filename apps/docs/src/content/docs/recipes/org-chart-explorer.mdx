...
description: "Build a searchable people directory with md-organization-chart, highlighted matches, profile details, contact actions, and breadcrumb reporting lines."
tableOfContents:
  maxHeadingLevel: 2
---
