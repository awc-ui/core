...
description: "Build a content moderation queue with report cards, reason chips, ML confidence, segmented verdicts, removal actions, and snackbar confirmations."
tableOfContents:
  maxHeadingLevel: 2
---
