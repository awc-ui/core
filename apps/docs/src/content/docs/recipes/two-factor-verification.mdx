...
<ComponentDemo
  ...
  <md-loading-indicator data-verifying hidden aria-label="Verifying code" style="justify-self: center;"></md-loading-indicator>
...
export default function TwoFactorVerification() {
  ...
  angular={`import { Component, OnDestroy, OnInit } from '@angular/core';
