...
description: "Build a release-health dashboard with environment chips, status dots, error sparklines, adoption metrics, drilldown charts, and rollback actions."
tableOfContents:
  maxHeadingLevel: 2
---
