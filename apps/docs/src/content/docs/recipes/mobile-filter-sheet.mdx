...
description: "Build mobile product filters in a bottom sheet with brand multi-select, price range, size chips, sorting, live result counts, and removable filters."
tableOfContents:
  maxHeadingLevel: 2
---
