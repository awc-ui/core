---
title: Dark Mode
description: Enable and customize AWC UI dark mode with one data attribute, Material Design 3 color tokens, system preferences, scoped themes, and persistence.
sidebar:
  order: 5
---
