...
On merge to `main`, the docs site auto-deploys to Netlify (`awcui.io`). Tagged releases publish to npm under the `@awc-ui` scope with [Sigstore provenance](https://docs.npmjs.com/generating-provenance-statements).
