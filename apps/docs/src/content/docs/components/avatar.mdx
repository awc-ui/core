...
<md-avatar shape="square" name="Meridian Industries" label="Meridian Industries"></md-avatar>`}
...
The avatar is not focusable, so the 48px touch rule never applies to it — but
