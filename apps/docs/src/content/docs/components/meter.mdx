...
`md-meter` deliberately has no indeterminate mode, no M3-Expressive 4dp gap, no
...
<ComponentDemo
  html={`<div style="display: flex; flex-direction: column; gap: 20px; inline-size: 100%; max-inline-size: 360px;">
  <md-meter value="65" thickness="2" label="2dp"></md-meter>
  <md-meter value="65" label="4dp (default)"></md-meter>
  <md-meter value="65" thickness="8" label="8dp"></md-meter>
  <md-meter value="65" thickness="12" label="12dp"></md-meter>
</div>`}
...
`density="-1…-4"` thins the track (4dp down to the 2px floor at `-4`) and
...
| `--md-meter-height` | Track thickness | `thickness` prop (4dp, density-scaled) |
| `--md-meter-size` | Ring diameter (circular only) | `size` prop (48dp, density-scaled) |
