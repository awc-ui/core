...
its circular variant floors at 24px unless you set one, which is exactly why the
...
`md-progress-indicator` clamps its circular variant to M3's **24px minimum**, so
