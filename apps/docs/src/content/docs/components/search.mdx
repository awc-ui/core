...
The leading / trailing icon buttons shrink 4px per rung: 44px at `-1`, 40px at
`-2`, 36px at `-3`, 32px at `-4` — under the minimum recommended by
...
inline bars spring from 24px to 12px.
:::
