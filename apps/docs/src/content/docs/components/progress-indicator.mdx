...
|---|---|---|
| `linear` | **Default.** `inline-size: 100%`, 4dp tall | A bar under a header, row, or app bar |
| `circular` | 40dp ring (48dp when `wave`) | A compact spinner inline with content |
...
`size` is the ring diameter in dp. M3 specifies a range of **24dp minimum to
240dp maximum** and the component clamps to it — smaller values snap up, larger
snap down.
...
default" (40dp flat, 48dp wavy). To hide an indicator, use CSS.
:::

<ComponentDemo
  html={`<md-progress-indicator variant="circular" value="60" size="24" thickness="2" label="24dp"></md-progress-indicator>
<md-progress-indicator variant="circular" value="60" size="32" thickness="3" label="32dp"></md-progress-indicator>
<md-progress-indicator variant="circular" value="60" size="40" thickness="4" label="40dp"></md-progress-indicator>
<md-progress-indicator variant="circular" value="60" size="48" thickness="4" label="48dp"></md-progress-indicator>
<md-progress-indicator variant="circular" value="60" size="64" thickness="6" label="64dp"></md-progress-indicator>
<md-progress-indicator variant="circular" value="60" size="96" thickness="10" label="96dp"></md-progress-indicator>`}
...
(linear: amplitude 3dp, wavelength 40dp; circular: amplitude 1.6dp, wavelength
15dp; speed tracks the wavelength at roughly one wave per second).
...
<md-progress-indicator variant="circular" wave value="50" size="72" thickness="6" label="72dp"></md-progress-indicator>
...
| `--md-progress-indicator-stop-indicator-color` / `-shape` / `-size` | End stop dot | `primary` / `corner-full` / 4dp |
| `--md-progress-indicator-stop-indicator-trailing-space` | Space past the stop dot | `0px` |
| `--md-progress-indicator-track-active-indicator-space` | Gap between track and fill | 4dp |
