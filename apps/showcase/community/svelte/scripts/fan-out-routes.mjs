 ...
 * RUNNING. A cold request for `/showcase/community/svelte/households/hh-01/`
 ...
 *
 * The usual fix is a host rewrite (`/showcase/community/svelte/* →
 * /showcase/community/svelte/index.html 200`). That rule is still worth having —
