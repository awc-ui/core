...
import { REPORTING_DATE } from '@awc-ui/showcase-kit/community';
...
<html${attrs({ lang: locale, dir, 'data-locale-route': true })}>
  <head>
    ...
    <title>${t('community.app.brand')} — ${t('community.app.title')}</title>
    <meta name="description"${attrs({ content: t('community.app.title') })} />
