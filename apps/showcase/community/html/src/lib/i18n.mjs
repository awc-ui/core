 ...
 * a navigation:
 *
 *   /showcase/community/html/           en   (default, unprefixed)
 *   /showcase/community/html/ro/        ro
 *   /showcase/community/html/ar/        ar   (dir="rtl")
 *
...
/**
 * A callable translator: `t('community.table.drift')` rather than
 * `t.t('community.table.drift')`, with the locale-bound `Intl` formatters hanging
 * off the same value.
 *
