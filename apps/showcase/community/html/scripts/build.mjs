 ...
 *
 * Seven screens — but the two drills fan out over the fixture, so it is 5
 * destinations + 42 posts + 24 people = 71 pages per locale, and three
 * locales. There is
...
async function main() {
  ...
  cpSync(require_.resolve('@awc-ui/showcase-kit/community/app.css'), join(dist, 'styles/app.css'));
