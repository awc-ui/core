 ...
 * RUNNING. A cold request for `/showcase/community/vue/households/hh-01/` reaches
 ...
 *
 * The usual fix is a host rewrite (`/showcase/community/vue/* →
 * /showcase/community/vue/index.html 200`). That rule is still worth having — it
