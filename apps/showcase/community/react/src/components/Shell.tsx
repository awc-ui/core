...
import { DESTINATIONS, getTotals, getViewer, type CrumbSpec } from '@awc-ui/showcase-kit/community';
      ...
      */}
      ...
      {DESTINATIONS.map((destination) => (
        <md-navigation-rail-tab
          ...
          /* The badge counts friend requests waiting on the reader. It sits on
             Friends because that is the screen that answers them — a count on
             a destination that cannot act on the thing it counts is a dead
             end. It is also the only number in this app somebody else is
             blocked on, which is what earns it the one badge. */
          badge-value={
    ...
    <>
      ...
      {actions ? (
        <div className="screen-toolbar">
          ...
          <md-toolbar variant="floating" color="vibrant" aria-label={t('community.nav.toolbar')}>
            {actions}
          </md-toolbar>
        </div>
      ) : null}
