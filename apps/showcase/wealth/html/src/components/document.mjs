...
import { REPORTING_DATE } from '@awc-ui/showcase-kit/wealth';
...
<html${attrs({ lang: locale, dir, 'data-locale-route': true })}>
  <head>
    ...
    <title>${t('wealth.app.brand')} — ${t('wealth.app.title')}</title>
    <meta name="description"${attrs({ content: t('wealth.app.subtitle') })} />
