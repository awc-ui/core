 ...
 *   pnpm --filter @awc-ui/showcase-wealth-svelte verify
 *
...
import { createRoutes, DESTINATIONS, FRAMEWORKS } from '@awc-ui/showcase-kit/wealth';
 ...
 * (`/showcase/wealth/svelte/* → …/index.html 200`) and the only condition
...
/* ------------------------------------------------------------------- the dock */
{
  ...
  ok('it is labelled as the wealth console', Boolean(probe.label) && !/credit/i.test(String(probe.label)), String(probe.label ?? '(none)'));
