<!--
  ...
  0…10 percentage points and the direction is carried by the colour, the status
  chip and the signed text beside it. Reading the bar alone never says a
