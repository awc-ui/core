<!--
  ...
  context, and the signed-in advisor.
-->
<script lang="ts">
...
>
  <!--
    ...
    Every proper noun in this app is invented — the bank, the households, the
    instruments, the advisors — and it is all presented in the shape of a real
