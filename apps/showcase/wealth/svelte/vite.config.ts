 ...
 * `/showcase/wealth/<framework>/`, so every asset URL, every link and the
 ...
 * being loaded — so both read `SHOWCASE_BASE` from `@awc-ui/showcase-kit/wealth`
 ...
 * stages into `apps/docs/public/showcase/wealth/svelte/`.
 */
