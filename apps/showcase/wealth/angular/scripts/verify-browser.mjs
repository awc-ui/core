 ...
 *   pnpm --filter @awc-ui/showcase-wealth-angular build
 *   pnpm --filter @awc-ui/showcase-wealth-angular verify
 *
...
/* -------------------------------------------------------------- 8. the dock */
{
  ...
  ok('the dock is labelled for the wealth console', !!probe.label, probe.label ?? '(none)');
