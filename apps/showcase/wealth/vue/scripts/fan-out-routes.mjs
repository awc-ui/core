 ...
 * RUNNING. A cold request for `/showcase/wealth/vue/households/hh-01/` reaches
 ...
 *
 * The usual fix is a host rewrite (`/showcase/wealth/vue/* →
 * /showcase/wealth/vue/index.html 200`). That rule is still worth having — it
