 ...
 * OUTCOMES a reader could see rather than on how Angular implemented them.
 *
 * Starts its own server, so it needs nothing running:
 *   pnpm --filter @awc-ui/showcase-music-angular build
 *   pnpm --filter @awc-ui/showcase-music-angular verify
 */
...
const PORT = 4383;
const BASE = `http://localhost:${PORT}${SHOWCASE_BASE}/angular`;
