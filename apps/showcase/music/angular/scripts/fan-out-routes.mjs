 ...
 * RUNNING. A cold request for `/showcase/music/angular/households/hh-01/`
 ...
 *
 * The usual fix is a host rewrite (`/showcase/music/angular/* →
 * /showcase/music/angular/index.html 200`). That rule is still worth having,
...
/* Angular's `application` builder always writes the browser bundle into
   ...
   `apps/docs/public/showcase/music/angular/`. */
