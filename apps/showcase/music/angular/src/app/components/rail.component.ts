...
export class RailComponent extends ShowcaseComponent {
  ...
  /*
   * NO BADGE ANYWHERE IN THIS APP, and that is a decision rather than an
   * omission. A badge is for a count somebody else is blocked on; a queue
   * length and a project count are the reader's own state, and badging them
   * would train a reader to ignore the one place a badge might later matter.
   */
