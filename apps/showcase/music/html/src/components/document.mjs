...
import { REPORTING_DATE } from '@awc-ui/showcase-kit/music';
...
<html${attrs({ lang: locale, dir, 'data-locale-route': true })}>
  <head>
    ...
    <title>${t('music.app.brand')} — ${t('music.app.title')}</title>
    <meta name="description"${attrs({ content: t('music.app.title') })} />
