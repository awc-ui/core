 ...
 * a navigation:
 *
 *   /showcase/music/html/           en   (default, unprefixed)
 *   /showcase/music/html/ro/        ro
 *   /showcase/music/html/ar/        ar   (dir="rtl")
 *
...
/**
 * A callable translator: `t('music.table.drift')` rather than
 * `t.t('music.table.drift')`, with the locale-bound `Intl` formatters hanging
 * off the same value.
 *
