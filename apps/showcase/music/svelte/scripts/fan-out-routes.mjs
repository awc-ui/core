 ...
 * RUNNING. A cold request for `/showcase/music/svelte/households/hh-01/`
 ...
 *
 * The usual fix is a host rewrite (`/showcase/music/svelte/* →
 * /showcase/music/svelte/index.html 200`). That rule is still worth having —
