...
<div class="shell">
  ...
  <!-- ABOVE THE ROUTER AND BELOW THE SCREEN: a navigation replaces the screen
     and leaves this element, and everything it is playing. -->
  <Transport />
...
<!-- LAST IN THE DOCUMENT, matching React, where the snackbar provider renders
     ...
     visual difference — but the parity census compares element ORDER. -->
<SnackbarHost />
