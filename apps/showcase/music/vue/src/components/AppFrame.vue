...
import SnackbarHost from './screens/SnackbarHost.vue';
...
<template>
  <div class="shell">
    ...
    <!-- ABOVE THE ROUTER AND BELOW THE SCREEN. A navigation replaces the
         screen and leaves this element — and everything it is playing. -->
    <Transport />
  ...
  <!-- LAST IN THE DOCUMENT, matching React, where the snackbar provider renders
       it after its children. It is `position: fixed` so where it sits makes no
       visual difference — but the parity census compares element ORDER, and a
       snackbar in the middle of the shell reads as a different document. -->
  <SnackbarHost />
</template>
