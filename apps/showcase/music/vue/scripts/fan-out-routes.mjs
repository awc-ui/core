 ...
 * RUNNING. A cold request for `/showcase/music/vue/households/hh-01/` reaches
 ...
 *
 * The usual fix is a host rewrite (`/showcase/music/vue/* →
 * /showcase/music/vue/index.html 200`). That rule is still worth having — it
