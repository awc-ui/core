...
/** The screen path. Vue Router strips `baseURL` for us, so this is already bare. */
const here = computed(() => currentRoute.path || '/');
...
function intercept(event: Event) {
  ...
  // Vue Router owns paths WITHOUT the base, and these hrefs carry it.
