 ...
 * same length and the same order. All three panels are rendered up front — the
 * panel component hides the inactive ones — which is what we want: the rating
 * history and the group tree are in the DOM, and in the parity fingerprint,
 * whether or not the visitor opens those tabs.
 *
