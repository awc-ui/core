 ...
 * drags Stencil's lazy loader into the Next bundle — and a bundled loader looks
 * for its entry chunks under `/_next/static/…`, where the export never wrote
 * them. That was measured on the docs site first (see `scripts/sync-runtime.mjs`)
 * and is why the components arrive from a static `<script type="module">`.
 *
