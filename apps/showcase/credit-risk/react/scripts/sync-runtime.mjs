 ...
 * getting the components to load through a bundler, and they apply verbatim to
 * a Next static export:
 *
 ...
 *      where Next never emitted them — every element 404s and renders at zero
 *      height.
