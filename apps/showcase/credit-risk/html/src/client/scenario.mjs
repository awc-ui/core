 ...
 * between them, on this build and on Astro, and nowhere else. The wrapper is
 * gone; the panels are direct children of the screen's column, exactly as they
 * are in every other build.
 */

/** Swap one marked panel for the same panel from the requested scenario. */
function swap(scenario, slot) {
...
export function enhanceScenarioSelector() {
