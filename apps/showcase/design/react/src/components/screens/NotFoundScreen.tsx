...
export function NotFoundScreen() {
  ...
  return (
    <Screen title={t('design.screen.notFound.title')} subtitle={t('design.screen.notFound.subtitle')}>
      <EmptyState message={t('design.screen.notFound.subtitle')} />
      <div className="row">
        <md-button
          class="notfound__home"
          variant="filled"
          icon="home"
          onClick={() => push(route.projects())}
        >
          {t('design.nav.projects')}
        </md-button>
      </div>
    </Screen>
  );
