...
import { TextControl, SelectControl } from '@/components/editor/controls';
import { useDocument } from '@/lib/document';
import { colorOf, layerFromAsset, LIVE_COMPONENTS, createLayer } from '@/lib/editor-model';
...
export function AssetsScreen() {
  ...
  const [query, setQuery] = useState(''), [kind, setKind] = useState('all'), [limit, setLimit] = useState(24);
