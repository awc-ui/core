 ...
 * `/showcase/design/<framework>/`, so every asset URL, every link and the
 ...
 * being loaded — so both read `SHOWCASE_BASE` from `@awc-ui/showcase-kit/design`
...
import { FRAMEWORKS, REPORTING_DATE, SHOWCASE_BASE } from '@awc-ui/showcase-kit/design';
...
export default defineConfig({
  esbuild: { jsxFactory: 'dom', jsxFragment: 'Fragment' },
  base: `${BASE_PATH}/`,
  plugins: [showcaseHead(), externalHeadScripts(), stripHtmlComments(), siblings()],
  resolve: {
