...
<script lang="ts">
  ...
  function measure() {
    ...
    atStart = offset < 2;
    atEnd = offset + scroller.clientWidth >= scroller.scrollWidth - 2;
  }
...
<section class="story-rail" aria-label={$t('social.panel.stories')}>
  ...
  <div bind:this={scroller} class="story-rail__scroller">
    {#each rings as ring (ring.person.id)}
      <div class="story">
