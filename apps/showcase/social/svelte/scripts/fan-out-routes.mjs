 ...
 * RUNNING. A cold request for `/showcase/social/svelte/households/hh-01/`
 ...
 *
 * The usual fix is a host rewrite (`/showcase/social/svelte/* →
 * /showcase/social/svelte/index.html 200`). That rule is still worth having —
