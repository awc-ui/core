 ...
 * RUNNING. A cold request for `/showcase/banking/vue/households/hh-01/` reaches
 ...
 *
 * The usual fix is a host rewrite (`/showcase/banking/vue/* →
 * /showcase/banking/vue/index.html 200`). That rule is still worth having — it
...
if (!existsSync(source)) {
  console.error(
    `[fan-out] ${source} does not exist — build first:\n` +
      '          pnpm --filter @awc-ui/showcase-banking-vue build',
  );
  process.exit(1);
}
