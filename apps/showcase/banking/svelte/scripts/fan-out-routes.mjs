 ...
 * RUNNING. A cold request for `/showcase/banking/svelte/households/hh-01/`
 ...
 *
 * The usual fix is a host rewrite (`/showcase/banking/svelte/* →
 * /showcase/banking/svelte/index.html 200`). That rule is still worth having —
