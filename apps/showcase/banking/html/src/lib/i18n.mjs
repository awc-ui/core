 ...
 * a navigation:
 *
 *   /showcase/banking/html/           en   (default, unprefixed)
 *   /showcase/banking/html/ro/        ro
 *   /showcase/banking/html/ar/        ar   (dir="rtl")
 *
...
/**
 * A callable translator: `t('banking.table.drift')` rather than
 * `t.t('banking.table.drift')`, with the locale-bound `Intl` formatters hanging
 * off the same value.
 *
