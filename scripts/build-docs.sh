...
# 4. Build every showcase vertical's framework builds (embedded at /showcase/)
# 5. Build the Astro docs site, staging Frame, Medflow, Metro pulse, and Sentinel
#    through its integrations (Pagefind is auto-generated by Starlight)
#
...
echo ""
echo "==> Building React wrappers for Metro pulse..."
pnpm --filter @awc-ui/react build
...
node scripts/verify-standalone-showcases.mjs
